...
@section('title','管理后台-商品添加')

<!--页面顶部信息-->
@section('pageHeader')
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> 商品添加 <span>Subtitle goes here...</span></h2>
    ...
    <div id="goods_add">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">商品添加表单</h4>
            </div>
            ...
            <!--通用信息-->
                <div class="panel-body panel-body-nopadding" v-show="tab==1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="关键字" class="form-control" name="keywords" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="上架时间" class="form-control" name="shop_time" value="{{date('Y-m-d H:i:s')}}" id="shop_time"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="发布时间" class="form-control"  name="sort" value="{{rand(1,100)}}" />
                        </div>
