    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <form class="form-horizontal form-bordered" action="{{route('admin.author.store')}}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="作者名称" class="form-control" name='author_name' value="{{$author->author_name or null}}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="作者描述" class="form-control"  name="author_desc" value="{{$author->author_desc or null}}"/>
                </div>
            </div>
