...
@section('pageHeader')
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> 商品类型添加 <span>Subtitle goes here...</span></h2>
...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/goods/type/store" method="post">
                {{csrf_field()}}

                <div class="form-group">
                    <label class="col-sm-3 control-label">类型名字</label>
                    <div class="col-sm-6">
                        <input type="text" placeholder="类型名字" class="form-control" name="type_name" value="" />
                    </div>
                </div>
                <div class="form-group">
